...
const CATEGORIES = [
  ...
  'Health', 'Travel', 'Food', 'Music', 'Photography',
...
const REAL_SERVICES: AppDefinition[] = [
  ...
  { id: 'disk-analyzer', name: 'disk-analyzer', display_name: 'Disk Analyzer', icon: 'hard-drive', description: 'Visualize disk usage with interactive charts', category: 'System Tools', launch_type: 'route', url: '/storage', tags: ['disk', 'storage', 'analysis'] },
  { id: 'log-viewer', name: 'log-viewer', display_name: 'Log Viewer', icon: 'file-text', description: 'Browse and search system logs', category: 'System Tools', launch_type: 'route', url: '/system-tools', tags: ['logs', 'debug'] },
  { id: 'backup-manager', name: 'backup-manager', display_name: 'Backup Manager', icon: 'database', description: 'Create and restore system backups', category: 'System Tools', launch_type: 'route', url: '/settings', tags: ['backup', 'restore'] },
  { id: 'update-manager', name: 'update-manager', display_name: 'Update Manager', icon: 'download', description: 'Check for and install system updates', category: 'System Tools', launch_type: 'route', url: '/settings', tags: ['update', 'system'] },
  ...
  { id: 'regex-tester', name: 'regex-tester', display_name: 'Regex Tester', icon: 'code', description: 'Test regular expressions in real-time', category: 'Developer', launch_type: 'iframe', url: 'https://regex101.com', tags: ['regex', 'testing'] },
  { id: 'sql-editor', name: 'sql-editor', display_name: 'SQL Editor', icon: 'database', description: 'Write and execute SQL queries', category: 'Developer', launch_type: 'iframe', url: 'https://sqliteonline.com', tags: ['sql', 'database', 'query'] },
  { id: 'git-explorer', name: 'git-explorer', display_name: 'Git Explorer', icon: 'git-branch', description: 'Browse git repositories and commits', category: 'Developer', launch_type: 'route', url: '/tools', tags: ['git', 'version-control'] },
  { id: 'api-tester', name: 'api-tester', display_name: 'API Tester', icon: 'external-link', description: 'Test REST APIs with custom requests', category: 'Developer', launch_type: 'iframe', url: 'https://hoppscotch.io', tags: ['api', 'rest', 'testing'] },
  ...
  { id: 'internet-radio', name: 'internet-radio', display_name: 'Internet Radio', icon: 'radio', description: 'Stream thousands of internet radio stations', category: 'Media', launch_type: 'iframe', url: 'https://radio.garden', tags: ['radio', 'streaming'] },
  { id: 'video-player', name: 'video-player', display_name: 'Video Player', icon: 'video', description: 'Play video files with subtitle support', category: 'Media', launch_type: 'iframe', url: 'https://www.youtube.com', tags: ['video', 'player'] },
  { id: 'photo-gallery', name: 'photo-gallery', display_name: 'Photo Gallery', icon: 'image', description: 'Browse and organize photos', category: 'Media', launch_type: 'route', url: '/storage', tags: ['photos', 'gallery', 'images'] },
  { id: 'audio-recorder', name: 'audio-recorder', display_name: 'Audio Recorder', icon: 'mic', description: 'Record audio from your microphone', category: 'Media', launch_type: 'iframe', url: 'https://online-voice-recorder.com', tags: ['audio', 'recorder', 'mic'] },
  ...
  { id: 'todo-list', name: 'todo-list', display_name: 'Todo List', icon: 'list', description: 'Manage tasks with priorities and categories', category: 'Productivity', launch_type: 'route', url: '/tools', tags: ['todo', 'tasks', 'productivity'] },
  { id: 'bookmarks', name: 'bookmarks', display_name: 'Bookmarks', icon: 'bookmark', description: 'Save and organize web bookmarks', category: 'Productivity', launch_type: 'route', url: '/tools', tags: ['bookmarks', 'links'] },
  { id: 'password-manager', name: 'password-manager', display_name: 'Password Manager', icon: 'lock', description: 'Generate and store secure passwords', category: 'Productivity', launch_type: 'route', url: '/tools', tags: ['passwords', 'security'] },
  { id: 'qrcode-generator', name: 'qrcode-generator', display_name: 'QR Code Generator', icon: 'grid', description: 'Generate QR codes for any text or URL', category: 'Productivity', launch_type: 'route', url: '/tools', tags: ['qr', 'barcode'] },
  ...
  { id: 'font-viewer', name: 'font-viewer', display_name: 'Font Viewer', icon: 'type', description: 'Browse and preview system fonts', category: 'Utilities', launch_type: 'iframe', url: 'https://fonts.google.com', tags: ['fonts', 'typography'] },
  { id: 'ip-lookup', name: 'ip-lookup', display_name: 'IP Address Lookup', icon: 'globe', description: 'Look up your IP address and location', category: 'Utilities', launch_type: 'iframe', url: 'https://whatismyipaddress.com', tags: ['ip', 'network', 'lookup'] },
  { id: 'file-converter', name: 'file-converter', display_name: 'File Converter', icon: 'upload', description: 'Convert files between different formats', category: 'Utilities', launch_type: 'iframe', url: 'https://cloudconvert.com', tags: ['convert', 'files'] },
  { id: 'timezone-converter', name: 'timezone-converter', display_name: 'Timezone Converter', icon: 'clock', description: 'Convert times across different timezones', category: 'Utilities', launch_type: 'iframe', url: 'https://www.timeanddate.com/worldclock/converter.html', tags: ['timezone', 'time'] },
  ...
  { id: 'snake', name: 'snake', display_name: 'Snake Game', icon: 'activity', description: 'Classic snake game with increasing speed', category: 'Games', launch_type: 'iframe', url: 'https://playsnake.org', tags: ['snake', 'classic', 'game'] },
  { id: 'tetris', name: 'tetris', display_name: 'Tetris', icon: 'grid', description: 'Classic Tetris block puzzle game', category: 'Games', launch_type: 'iframe', url: 'https://tetris.com/play-tetris', featured: true, tags: ['tetris', 'blocks', 'puzzle'] },
  { id: 'pacman', name: 'pacman', display_name: 'Pac-Man', icon: 'grid', description: 'Classic Pac-Man arcade game', category: 'Games', launch_type: 'iframe', url: 'https://www.google.com/logos/2010/pacman10-i.html', tags: ['pacman', 'arcade', 'classic'] },
  { id: 'solitaire', name: 'solitaire', display_name: 'Solitaire', icon: 'grid', description: 'Classic Klondike Solitaire card game', category: 'Games', launch_type: 'iframe', url: 'https://solitaired.com', tags: ['solitaire', 'cards', 'game'] },
  ...
  { id: 'ai-code-gen', name: 'ai-code-gen', display_name: 'AI Code Generator', icon: 'code', description: 'Generate code from natural language', category: 'AI Tools', launch_type: 'route', url: '/ai', tags: ['ai', 'code', 'programming'] },
  { id: 'ai-translator', name: 'ai-translator', display_name: 'AI Translator', icon: 'globe', description: 'Translate text between any languages', category: 'AI Tools', launch_type: 'iframe', url: 'https://translate.google.com', featured: true, tags: ['translate', 'language', 'ai'] },
  ...
  { id: 'wifi-analyzer', name: 'wifi-analyzer', display_name: 'WiFi Analyzer', icon: 'wifi', description: 'Analyze WiFi networks and signal strength', category: 'Network', launch_type: 'route', url: '/settings', tags: ['wifi', 'analyzer'] },
  { id: 'vpn-manager', name: 'vpn-manager', display_name: 'VPN Manager', icon: 'lock', description: 'Manage VPN connections', category: 'Network', launch_type: 'iframe', url: 'https://www.windscribe.com', tags: ['vpn', 'network', 'privacy'] },
  { id: 'dns-lookup', name: 'dns-lookup', display_name: 'DNS Lookup', icon: 'globe', description: 'Look up DNS records for any domain', category: 'Network', launch_type: 'iframe', url: 'https://dns.google', tags: ['dns', 'lookup', 'network'] },
  { id: 'network-scanner', name: 'network-scanner', display_name: 'Network Scanner', icon: 'monitor', description: 'Scan your network for connected devices', category: 'Network', launch_type: 'route', url: '/devices', tags: ['scan', 'network', 'devices'] },
  ...
  { id: 'vulnerability-scanner', name: 'vulnerability-scanner', display_name: 'Vulnerability Scanner', icon: 'shield', description: 'Scan for system vulnerabilities', category: 'Security', launch_type: 'iframe', url: 'https://pentest-tools.com', tags: ['security', 'vulnerability', 'scan'] },
  { id: 'ssl-checker', name: 'ssl-checker', display_name: 'SSL Certificate Checker', icon: 'shield', description: 'Check SSL certificate validity and expiry', category: 'Security', launch_type: 'iframe', url: 'https://www.sslshopper.com/ssl-checker.html', tags: ['ssl', 'certificate', 'security'] },
  ...
  { id: 'google-sheets', name: 'google-sheets', display_name: 'Google Sheets', icon: 'grid', description: 'Create and edit spreadsheets online', category: 'External Services', launch_type: 'tab', url: 'https://sheets.google.com', tags: ['sheets', 'spreadsheets'] },
  { id: 'youtube', name: 'youtube', display_name: 'YouTube', icon: 'video', description: 'Watch and discover videos', category: 'External Services', launch_type: 'tab', url: 'https://youtube.com', featured: true, tags: ['youtube', 'video', 'streaming'] },
  { id: 'spotify', name: 'spotify', display_name: 'Spotify', icon: 'music', description: 'Stream music and podcasts', category: 'External Services', launch_type: 'tab', url: 'https://open.spotify.com', featured: true, tags: ['spotify', 'music', 'streaming'] },
  { id: 'netflix', name: 'netflix', display_name: 'Netflix', icon: 'tv', description: 'Stream movies and TV shows', category: 'External Services', launch_type: 'tab', url: 'https://netflix.com', tags: ['netflix', 'streaming', 'video'] },
  { id: 'reddit', name: 'reddit', display_name: 'Reddit', icon: 'message-circle', description: 'Browse communities and discussions', category: 'External Services', launch_type: 'tab', url: 'https://reddit.com', tags: ['reddit', 'social', 'community'] },
  { id: 'wikipedia', name: 'wikipedia', display_name: 'Wikipedia', icon: 'book', description: 'Browse the free encyclopedia', category: 'External Services', launch_type: 'tab', url: 'https://wikipedia.org', featured: true, tags: ['wikipedia', 'reference', 'knowledge'] },
  { id: 'stackoverflow', name: 'stackoverflow', display_name: 'Stack Overflow', icon: 'code', description: 'Q&A for programmers', category: 'External Services', launch_type: 'tab', url: 'https://stackoverflow.com', tags: ['programming', 'qa', 'code'] },
  ...
  { id: 'public-transit', name: 'public-transit', display_name: 'Public Transit', icon: 'map', description: 'Plan routes with public transportation', category: 'Travel', launch_type: 'tab', url: 'https://moovit.com', tags: ['transit', 'routes', 'travel'] },
